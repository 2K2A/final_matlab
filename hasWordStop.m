function has_word_stop = hasWordStop(image)
...
if (contains(string, 'ST') == 1)
    has_word_stop = 50;
    return
end
if (contains(string, 'TO') == 1)
    has_word_stop = 50;
    return
end
if (contains(string, 'OP') == 1)
    has_word_stop = 50;
    return
end
if (contains(string, 'S') == 1)
    has_word_stop = 25;
    return
end
if (contains(string, 'T') == 1)
    has_word_stop = 25;
    return
end
if (contains(string, 'O') == 1)
    has_word_stop = 25;
    return
end
if (contains(string, 'P') == 1)
    has_word_stop = 25;
    return
end
